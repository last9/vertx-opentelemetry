...
/**
 * Enables automatic OpenTelemetry context propagation for RxJava2.
 *
 ...
 * @see OtelLauncher
 */
public class RxJava2ContextPropagation {

    private static final Logger log = LoggerFactory.getLogger(RxJava2ContextPropagation.class);
    private static final AtomicBoolean installed = new AtomicBoolean(false);

    /**
     * Install OpenTelemetry context propagation hooks for RxJava2.
     * Safe to call multiple times - will only register hooks once.
     */
    public static void install() {
        if (installed.compareAndSet(false, true)) {
            registerHooks();
            log.debug("RxJava2 OpenTelemetry context propagation hooks installed");
        }
    }
    ...
    private static void registerHooks() {
        ...
        RxJavaPlugins.setScheduleHandler(RxJava2ContextPropagation::wrapWithContext);
    }
